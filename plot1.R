...
create a Histogram for Global_active_power(kilowatts).
...
# Creating a Histogram to check the frequency of Global Active Power(kilowatts)
# Save it as a png file
       
	library(datasets)  			 
	hist(table[ ,3], col="red", xlab="Global Active Power(kilowatts)",ylab="Frequency", main="Global Active Power")
