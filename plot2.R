...
create a plots with Global_active_power,Voltage(kilowatts) in dependence to datetime variable.
...
#Creating Plot 2 and saving it as a png file

library(datasets)

with(table, plot(table$datetime,Global_active_power, type="l", xlab="", ylab="Global Active Power(kilowatts)"))
